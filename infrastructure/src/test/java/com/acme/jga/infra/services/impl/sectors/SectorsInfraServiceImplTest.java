...
class SectorsInfraServiceImplTest {
    @Mock
    SectorsConverter sectorsConverter;
    @Mock
    private SectorsDao sectorsDao;
    @InjectMocks
    private SectorsInfraServiceImpl sectorsInfraServiceImpl;
    ...
    void fetchSectorsWithHierarchy() {
        ...
        // THEN
        sectorsInfraServiceImpl.mapSectorsRecursively(rootSector, sectors);
