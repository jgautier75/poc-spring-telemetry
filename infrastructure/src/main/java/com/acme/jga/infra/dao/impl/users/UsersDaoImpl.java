...
public class UsersDaoImpl extends AbstractJdbcDaoSupport implements UsersDao {
    ...
    private static final String INSTRUMENTATION_NAME = UsersDaoImpl.class.getCanonicalName();
    private final ILoggingFacade loggingFacade;
    private static final String BASE_SELECT = "user_sel_base";

    public UsersDaoImpl(DataSource ds, NamedParameterJdbcTemplate namedParameterJdbcTemplate, ExpressionsProcessor expressionsProcessor,
