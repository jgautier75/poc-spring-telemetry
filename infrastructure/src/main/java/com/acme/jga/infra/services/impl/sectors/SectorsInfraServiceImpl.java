...
@Service
public class SectorsInfraServiceImpl extends AbstractInfraService implements SectorsInfraService {
    private static final String INSTRUMENTATION_NAME = SectorsInfraServiceImpl.class.getCanonicalName();
    ...
    public SectorsInfraServiceImpl(SectorsDao sectorsDao, SectorsConverter sectorsConverter, ILoggingFacade loggingFacade, OpenTelemetryWrapper openTelemetryWrapper) {
