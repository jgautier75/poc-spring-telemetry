...
public class SectorsController extends AbstractController {
    ...
    public SectorsController(ISectorsPortService sectorsPortService, OpenTelemetryWrapper openTelemetryWrapper) {
    ...
    public ResponseEntity<SectorDisplayDto> findSectors(@PathVariable("tenantUid") String tenantUid,
        ...
        SectorDisplayDto sectorDisplayDto = withSpan(INSTRUMENTATION_NAME, "API_SECTORS_LIST", (span) -> sectorsPortService.findSectors(tenantUid, orgUid, span));
