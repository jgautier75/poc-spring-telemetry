...
public class OrganizationCreateImpl extends AbstractOrganizationFunction implements OrganizationCreate {
    ...
    @Transactional
    @Audited
    public CompositeId execute(String tenantUid, Organization organization) {
        return processWithSpan(INSTRUMENTATION_NAME, "DOMAIN_ORGS_CREATE", (span) -> {
            ...
            CompositeId sectorCompositeId = sectorsInfraService.createSector(tenant.getId(), orgCompositeId.getId(), sector);
            ...
            generateSectorAuditEventAndPush(organization, tenant, sector, AuditAction.CREATE, sectorAuditChanges);
            ...
            generateOrgAuditEventAndPush(organization, tenant, AuditAction.CREATE, auditChanges);
