...
@Component
public class EventBuilderTenant {

    public List<AuditChange> buildAuditsChange(Tenant previous, Tenant current) {
        final List<AuditChange> auditChanges = new ArrayList<>();
        DiffResult<Tenant> diffResult = previous.diff(current);
